  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: "flex justify-between pt-1 relative items-center w-full px-8",
        ...
        cell: cn(
          "relative flex-1 p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent",
